...
public class TypedValue {
    ...
    /** The <var>data</var> field holds a dynamic resource identifier, which needs to be
     *  resolved before it can be used like a TYPE_REFERENCE. */
    public static final int TYPE_DYNAMIC_REFERENCE = 0x07;
    
    /** The <var>data</var> field holds a dynamic attribute resource identifier, which
     *  needs to be resolved before it can be used like a TYPE_ATTRIBUTE. */
